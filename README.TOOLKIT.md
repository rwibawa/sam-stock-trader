...
* sam-stock-trader:StockTradingStateMachine
* sam-stock-trader:StockCheckerFunction (nodejs14.x)
* sam-stock-trader:StockSellerFunction (nodejs14.x)
* sam-stock-trader:StockBuyerFunction (nodejs14.x)
* sam-stock-trader:TransactionTable
