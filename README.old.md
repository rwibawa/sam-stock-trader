...
```bash
sam-stock-trader$ sam logs -n StockCheckerFunction --stack-name sam-stock-trader --tail
```
...
```bash
sam-stock-trader$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name sam-stock-trader
```
